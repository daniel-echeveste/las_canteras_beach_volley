                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col justify-center items-center min-h-screen text-center text-white px-6 pt-20">
                        ...
                        <h1 className="text-5xl md:text-7xl font-extrabold drop-shadow-lg mb-6 animate-slide-up">
                            <span className="bg-gradient-to-b from-white via-[#FFD369] to-yellow-500 bg-clip-text text-transparent outline  ">
                                Vóley Playa
                            </span>
                            <br />
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex gap-6">
                                <a href="https://www.instagram.com/lascanterasbeachvolley/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1CA9C9] transition-colors">
                                ...
                                <a href="https://x.com/lascanterasbv" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-[#1CA9C9] transition-colors">
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
