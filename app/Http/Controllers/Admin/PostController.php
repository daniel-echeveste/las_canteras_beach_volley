...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'tournament_date' => 'required_if:post_type,torneo|nullable|date',
            'has_form' => 'boolean',
            ...
            'form_fields.*.type' => 'required|in:text,email,phone,tel,textarea,select',
        ...
        Post::create([
            ...
            'tournament_date' => $validated['tournament_date'] ?? null,
