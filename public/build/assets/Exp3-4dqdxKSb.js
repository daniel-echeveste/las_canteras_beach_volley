import{j as e,S as a,r as s}from"./app-CnKZAfCH.js";import{C as i,O as o}from"./OrbitControls-DLfJUhoA.js";import{N as n}from"./Navbar-DRPY1tzK.js";import{S as l,a as m}from"./Stars-BDi3Ynwp.js";import{u as c}from"./events-776716bd.esm-BbcrVFDs.js";import"./extends-CF3RwP-h.js";import"./constants-BmufKwDc.js";function x(){const t=s.useRef();return c((v,r)=>{t.current.material.uniforms.uTime.value+=r}),e.jsxs("mesh",{ref:t,rotation:[-Math.PI/2,0,0],position:[0,-2,0],children:[e.jsx("planeGeometry",{args:[100,100,64,64]}),e.jsx("shaderMaterial",{uniforms:{uTime:{value:0}},vertexShader:`
    varying vec2 vUv;
    uniform float uTime;
    void main() {
      vUv = uv;
