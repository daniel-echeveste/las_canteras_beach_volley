import{r as a,j as e}from"./app-CtYAKjJz.js";import{u as i,V as l,C as s}from"./events-776716bd.esm-BWDsjMVD.js";import{P as u}from"./shapes-BSeGxU6s.js";import"./extends-CF3RwP-h.js";var v=`varying vec2 vUv;
uniform float uTime;
...
}`;function C({sunPosition:o=[50,100,50],...t}){const n=a.useRef();return i((d,r)=>{n.current&&(n.current.material.uniforms.uTime.value+=r)}),e.jsx(u,{ref:n,args:[200,100,128,128],rotation:[-Math.PI/2,0,0],receiveShadow:!0,...t,children:e.jsx("shaderMaterial",{uniforms:{uTime:{value:0},uColor:{value:new s("#f2d2a9")},uSunPosition:{value:new l(...o)}},vertexShader:v,fragmentShader:f})})}export{C as default};
