import{j as e,S as a,r as s}from"./app-zSTEnHbn.js";import{C as i,O as o}from"./OrbitControls-ZwxMJgsN.js";import{N as n}from"./Navbar--7-NxthE.js";import{S as l,a as m}from"./Stars-oImTCLuE.js";import{x as c}from"./events-776716bd.esm-jx6sKZMk.js";import"./extends-CF3RwP-h.js";import"./constants-CcIFHZkK.js";function x(){const t=s.useRef();return c((v,r)=>{t.current.material.uniforms.uTime.value+=r}),e.jsxs("mesh",{ref:t,rotation:[-Math.PI/2,0,0],position:[0,-2,0],children:[e.jsx("planeGeometry",{args:[100,100,64,64]}),e.jsx("shaderMaterial",{uniforms:{uTime:{value:0}},vertexShader:`
    varying vec2 vUv;
    uniform float uTime;
    void main() {
      vUv = uv;
