import{j as e,S as a,r as s}from"./app-J9bkjMAo.js";import{C as i,O as o}from"./OrbitControls-CP3-5UE2.js";import{N as n}from"./Navbar-DdwnOP_5.js";import{S as l,a as m}from"./Stars-CCP-KMGR.js";import{x as c}from"./events-776716bd.esm-C1O7Gkhx.js";import"./extends-CF3RwP-h.js";import"./constants-Bqbg_KDP.js";function x(){const t=s.useRef();return c((v,r)=>{t.current.material.uniforms.uTime.value+=r}),e.jsxs("mesh",{ref:t,rotation:[-Math.PI/2,0,0],position:[0,-2,0],children:[e.jsx("planeGeometry",{args:[100,100,64,64]}),e.jsx("shaderMaterial",{uniforms:{uTime:{value:0}},vertexShader:`
    varying vec2 vUv;
    uniform float uTime;
    void main() {
      vUv = uv;
